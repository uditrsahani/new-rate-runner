...
const ContactEdit = (props) => {
  const { ContactID, AgentID, ...other } = props;
  ...
  const handleClose = () => {
    setOpen(false);
    if (complete) { window.location.assign(`/reference-data/agent/details/${AgentID}`); }
  };
                    ...
                    >
                      ...
                      <Box>
                        <Button
                          ...
                          size="large"
                          onClick={() => {
                            window.location.assign(`/reference-data/agent/details/${AgentID}`);
                          }}
                        >
                          CANCEL
                        </Button>
