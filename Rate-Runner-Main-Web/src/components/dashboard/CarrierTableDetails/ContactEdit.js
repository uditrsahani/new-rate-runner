...
const ContactEdit = (props) => {
  const { ContactID, CarrierID, ...other } = props;
  ...
  const handleClose = () => {
    setOpen(false);
    if (complete) { window.location.assign(`/reference-data/Carrier/details/${CarrierID}`); }
  };
    ...
    <>
      ...
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          ...
          if (values.ct_uuid === '') {
            Data = [{
              ct_refer_table: 'carrier',
              ct_refer_id: CarrierID,
                    ...
                    >
                      ...
                      <Box>
                        <Button
                          ...
                          size="large"
                          onClick={() => {
                            window.location.assign(`/reference-data/Carrier/details/${CarrierID}`);
                          }}
                        >
                          CANCEL
                        </Button>
